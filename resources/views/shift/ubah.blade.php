        ...
        <form action="{{ route('shift.update', $shift->id) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="kasir" name="kasir_id">
                    ...
                    <option value="{{ $kasir->id }}" {{ $kasir->id == $shift->kasir_id ? 'selected' : '' }}>
                            {{ $kasir->nama_kasir }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="toko" name="toko_id">
                    ...
                    <option value="{{ $toko->id }}" {{ $toko->id == $shift->toko_id ? 'selected' : '' }}>
                            {{ $toko->nama_toko }}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" id="waktu_masuk" value="{{ old('waktu_masuk', $shift->waktu_masuk) }}" name="waktu_masuk" placeholder="Masukkan waktu masuk" type="time" />
            </div>
            <div class="mb-3">
                <label class="form-label" for="waktu_keluar">
                    Waktu keluar
                </label>
                <input class="form-control" id="waktu_keluar" value="{{ old('waktu_keluar', $shift->waktu_keluar) }}" name="waktu_keluar" placeholder="Masukkan waktu keluar" type="time" />
            </div>
